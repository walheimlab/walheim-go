...
func registerApp() {
	...
	registry.Register(registry.Registration{
		...
		Operations: []registry.OperationDef{
			...
			{
				Verb:         "apply",
				Short:        "Create or update an app from a manifest file",
			...
			{
				Verb:         "delete",
				Short:        "Delete an app (stops containers, removes local and remote files)",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "describe",
				Short:        "Show detailed app status including live container info",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "import",
				Short:        "Wrap an existing docker-compose.yml into a Walheim app manifest",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Flags:        fileFlag,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "start",
				Short:        "Generate compose, sync, and start an app",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "pause",
				Short:        "Stop containers without removing remote files",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "stop",
				Short:        "Stop containers and remove remote files",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "pull",
				Short:        "Pull latest images without restarting",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Run: func(h resource.Handler, opts registry.OperationOpts) error {
			...
			{
				Verb:         "logs",
				Short:        "Stream or print app container logs",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
			...
			{
				Verb:         "exec",
				Short:        "Execute a command in a running app container",
				NSHandling:   registry.NSRequired,
				RequiresName: true,
				Flags: []registry.FlagDef{
			...
			{
				Verb:         "doctor",
				Short:        "Check apps for filesystem and manifest issues",
				NSHandling:   registry.NSOptionalAll,
				RequiresName: false,
				Examples: []string{
